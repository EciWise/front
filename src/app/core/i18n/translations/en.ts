...
export const en = {
  ...
  landing: {
    ...
    tabTeam: 'Team',
    gallery: {
      title: 'A look at the platform',
      subtitle: 'Browse some of the experiences ECIWISE+ brings together in one place.',
      label: 'Platform gallery',
      slide: 'Image',
    },
    team: {
      title: 'Made by',
      subtitle: 'The team of students and tutors that makes ECIWISE+ possible.',
      label: 'Project team',
      madeBy: 'Made by',
    },
    footer: {
