...
export const en = {
  ...
  practica: {
    ...
    modeDesc: {
      ...
      AI: 'Generate personalised questions with artificial intelligence on any topic.',
    },
    status: {
  ...
  aiAssistant: {
    ...
    errorNetwork: 'Could not connect to the assistant.',
    seed: 'Hi, I\'m your ECIWISE+ assistant. How can I help you today?',
  },
  aiQuiz: {
    topic: 'Quiz topic',
    topicPlaceholder: 'E.g.: Differential calculus, Thermodynamics…',
    ...
    answer: 'Answer',
    openAnswerPlaceholder: 'Write your answer…',
